...
RETROSPEC_DEFAULT_MAX_NUM_BATCHED_TOKENS = 512
...
class EngineArgs:
    ...
    def _set_default_max_num_seqs_and_batched_tokens_args(
        ...
        is_retrospec = speculative_method == "retrospec"

        if self.max_num_batched_tokens is None:
            if is_retrospec:
                self.max_num_batched_tokens = RETROSPEC_DEFAULT_MAX_NUM_BATCHED_TOKENS
            else:
