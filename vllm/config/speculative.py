...
class SpeculativeConfig:
    ...
    retrospec_max_draft_tokens: int = Field(default=8, gt=0)
    """Hard upper bound on tokens generated by one RetroSpec draft block.
    Dynamic draft signals may end the block before this limit."""
